function ItemCard(props){
	...
	if (props.comploc==="buyer")
		...
		return (
			...
			<div class="item-card shrink-0 m-8 mr-14 md:ml-14 xl:ml-16 flex flex-col rounded-xl md:h-5/6 md:w-5/12 xl:w-3/12 xl:h-5/6">
				<div class="px-5 bg-black py-7 my-3 rounded-full  m-auto md:h-5/6 xl:h-5/6 md:w-7/12 xl:w-5/12">
				</div>
				...
				<div class=" w-full h-full">
					...
					<div>
						<h1 class="product-name text-black text-2xl ml-2 mt-2">Ye tune bech diya hai bhai</h1>
					</div>
				</div>
			</div>
