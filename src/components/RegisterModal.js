                        ...
                        <div class="flex flex-col  h-full w-full">
                            <div class="flex  flex-col justify-center">
                                <div class="flex flex-col justify-center h-full -mt-5">
                                    <input id="register-email" type="text" placeholder="Enter email ID" class="modal-input w-inherit md:mx-9 xl:mx-12 border-b-4 rounded-sm border-black mt-20 mb-1"/>
                                    <input id="register-username" type="text" placeholder="Enter username" class="modal-input w-inherit md:mx-9 xl:mx-12 border-b-4 rounded-sm border-black mt-12 mb-1"/>
